...
(* OASIS_START *)
(* DO NOT EDIT (digest: a72a0eaf893f40c4069e6a5c33733de3) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ofmain.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\197`\247:\248C!\016\144\007\139\225V\237\189\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
