...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbef87142c043bf2d8d3d013b9b83d40) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "OldFashion is a simple and embeddable programming language.";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ofsyntax"];
                      lib_pack = false;
                      lib_internal_modules = ["Ofparser"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ofparser"];
                   ...
                   {exec_custom = false; exec_main_is = "oldfashion.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\169\193\001C\255\024#\024\239\195H\248\165\139J;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
